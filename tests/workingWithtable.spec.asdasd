...
test('Working with table', async ({page})=>{
    ...
    const countryWherePeopleSpeakPortuguese = countries.find(country => country.primaryLanguage === 'Portuguese');
...
//table[@id='countries']//tr[2]//td[5] -> Area
